...
_EXTRACT_SYSTEM = (
    ...
    # THREAD_SELF_ORIENT_V1 — nitka je o životě OSOBY, ne o Hansových tématech
    "KRITICKÉ ROZLIŠENÍ: nitka je o životě/plánech/aktivitách OSOBY. "
    "Když se osoba jen PTÁ {persona_name} na jeho vlastní věci (např. „jak ti "
    "jde studium?\", „co maluješ?\", „co jsi četl?\"), Hansova odpověď o vlastním "
    "studiu, obrazu, čtení, myšlence NENÍ nitka — {persona_name} si své věci "
    "řeší sám a nemá se dotazovat OSOBY, jak se JÍ daří balancovat jeho studium. "
    "Nitku vytvoř JEN když osoba mluví o SOBĚ / svém životě / svých plánech "
    "(např. „jedu v úterý na dovolenou\", „čtu Dostojevského\", „mám zítra zkoušku\", "
    "„natřeli jsme plot\"). Test: follow_up musí být otázka „jak DOPADLA tvá "
    "věc?\" — nikoli „jak se ti daří to, co je moje?\"."
